...
const Nav = ({ authenticated, setAuthenticated }) => {
  ...
  return (
    ...
    <IconButton sx={{ color: 'black' }} aria-label="login" size="small">
    <PersonIcon /> {authenticated ? "로그아웃" : "로그인"}
    </IconButton>
    </div>
      <div className='hamburger-button' onClick={toggleSidebar}>
        <IconButton sx={{ color: 'black' }} aria-label="menu" size="small">
          <MenuIcon />
        </IconButton>
      </div>
    ...
    <IconButton sx={{ color: 'black' }} aria-label="search" size="small">
    ...
    {sidebarOpen && (
        <div className='sidebar'>
          <div className='sidebar-header'>
            <IconButton sx={{ color: 'black' }} aria-label="close" size="small" onClick={toggleSidebar}>
              <CloseIcon />
            </IconButton>
          </div>
